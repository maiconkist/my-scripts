...
# Generated: Fri Mar  1 16:35:33 2019
##################################################
...
class ansible_hydra_lora_side2(gr.top_block):
    ...
    def __init__(self, ansibleFreqRx=0, ansibleFreqTx=0, ansibleRemoteIP='192.168.5.134', ansibleID='0', ansibleHostIP='192.168.5.134', bw=250e3, offset=-250e3):
...
def argument_parser():
    ...
    parser.add_option(
        "", "--ansibleRemoteIP", dest="ansibleRemoteIP", type="string", default='192.168.5.134',
...
def main(top_block_cls=ansible_hydra_lora_side2, options=None):
    ...
    tb = top_block_cls(ansibleFreqRx=options.ansibleFreqRx, ansibleFreqTx=options.ansibleFreqTx, ansibleRemoteIP=options.ansibleRemoteIP, ansibleID=options.ansibleID, ansibleHostIP=options.ansibleHostIP, bw=options.bw)
    tb.start()
    tb.wait()
