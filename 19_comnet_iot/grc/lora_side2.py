...
# Title: Lora Side2
# Generated: Thu Feb 28 12:33:27 2019
##################################################
...
class lora_side2(gr.top_block):

    def __init__(self, MTU=10000, bw=100e3, frequency_rx=2.4505e9 + 1e6, frequency_tx=2.4505e9, ip_pub='tcp://192.168.5.109:7000', ip_sub='tcp://192.168.5.134:7001', offset=-250e3):
...
def argument_parser():
    ...
    parser.add_option(
        "", "--ip-pub", dest="ip_pub", type="string", default='tcp://192.168.5.109:7000',
        help="Set ip_pub [default=%default]")
    parser.add_option(
        "", "--ip-sub", dest="ip_sub", type="string", default='tcp://192.168.5.134:7001',
