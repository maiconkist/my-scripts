...
# Generated: Mon Oct  2 17:47:41 2017
##################################################
...
class hydra_dump_to_files(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, fftm=128, filepattern="./", freq=950e6, freq1=947.5e6, freq2=951e6, samprate=6e6, samprate1=1e6, samprate2=500e3, vr1fft=512, vr1offset=0, vr2fft=512, vr2offset=319):
        ...
        self.amplitude2 = amplitude2 = 1.0
        self.amplitude1 = amplitude1 = 1.0

        ##################################################
        # Blocks
        ##################################################
        self._amplitude2_range = Range(0, 1.0, 0.01, 1.0, 200)
        ...
        self._amplitude1_range = Range(0.0, 1.0, 0.01, 1.0, 200)
        ...
        self.hydra_hydra_sink_0 = hydra.hydra_sink(1, fftm, freq, samprate,
        	 ((freq, samprate),
        	 ))
        ...
        self.blocks_throttle_1 = blocks.throttle(gr.sizeof_gr_complex*1, 6e6,True)
        ...
        self.blocks_head_0_0 = blocks.head(gr.sizeof_gr_complex*1, int(50e6))
        ...
        self.connect((self.blocks_head_0_0, 0), (self.qtgui_freq_sink_x_0_0_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.blocks_throttle_1, 0))
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.digital_ofdm_tx_0, 0))
        self.connect((self.blocks_stream_to_tagged_stream_0_1, 0), (self.digital_ofdm_tx_0_1, 0))
        self.connect((self.blocks_throttle_0, 0), (self.blocks_file_sink_0_0_0_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.blocks_throttle_1, 0), (self.blocks_head_0_0, 0))
    ...
    def set_freq(self, freq):
        self.freq = freq
        self.hydra_hydra_sink_0.set_central_frequency(0, self.freq)
